	...
	Counter.prototype.output = function(html, length, maxLength){
		$(this.options.source).html(html.replace(/\{(\w+)\}/g, function(all, word){
			switch(word) {
				...
				case 'remain': return maxLength - length;
				case 'overflow': return length - maxLength;
...
;(function () {
    ...
    ISelect.prototype = {
        render: function () {
            ...
            self.$ul = self.$node.find('.dropdown-menu');
...
;(function ($, undefined) {
    ...
    var formatCls = function () {
        return {
            ...
            , removeDot: function (clsName) {
                ...
                return clsName.replace(/^\./, function () {return '';});
            }
        }
    }();
    ...
    var iSwitch = function (element, config) {
        this.element = $(element);
        this.switchTrigger = $('.switch-statu', this.element);
...
+function ($) {
	...
	var Taber = function(element,options){
		...
		self.$element.attr('ac-modal',opts.tabs + ' Taber ' + opts.penals);
	};
  ...
  * =================== */
  ...
  $(function(){
    ...
    $(document).on('click', '[data-dismiss=tooltip]', function(e){
      e.preventDefault()
      $(e.target).parents('.tooltip').prev().trigger('click.tooltip')
    })
    $(document).on('click', '[data-ok=tooltip]', function(e){
      e.preventDefault()
      var triggerEle = $(e.target).parents('.tooltip').prev()
